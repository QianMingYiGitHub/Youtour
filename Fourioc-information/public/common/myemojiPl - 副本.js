...
alert("111111");
	...
	$.fn.myEmoji = function(options) {
		var defaults = {
			...
			postFunction: function() {
				$.ajax({
					url:'/wxqyh/reply/homework/'+homework_id+'?corpid='+corp_id+'&userid='+userid+'&identity='+identity+'&ext='+ext,
					type: 'get',
	...
	alert("现在是"+time);
		...
		function reply(content){
			...
			//html ='<a href="javascript:void(0);"  id="345" class="weui_media_box weui_media_appmsg">';
           // html +='<div class="weui_media_hd" id="touchArea">';
           // html +='<img  name="刘虐彤" class="weui_media_appmsg_thumb" src="images/index_icon_two.png" alt="">';
            //html +='</div>';
            //html +='<div class="weui_media_bd">';
           // html +='<h4 class="weui_media_title"><span class="name_box">刘虐彤</span><p class="time_box">2032.12.23<p></h4>';
           // html +='<p class="weui_media_desc">'+content+'</p>';
			// html +='<div class=""><span class="weui_btn weui_btn_mini weui_btn_warn delete_button" onclick="aaaa()">删除</span></div>';
           // html +='</div>';
           // html +='</a>';


			html ='<a href="javascript:void(0);"  id="1345" class="weui_media_box weui_media_appmsg">';
            html +='<div class="weui_media_hd" id="touchArea">';
            html +='<img  name="刘虐彤" class="weui_media_appmsg_thumb" src="images/index_icon_two.png" alt="">';
            html +='</div>';
            html +='<div class="weui_media_bd">';
            html +='<h4 class="weui_media_title"><span class="name_box">刘虐彤</span><p class="time_box">2032.12.23<p></h4>';
            html +='<p class="weui_media_desc">'+content+'</p>';
			 html +='<div class=""><span class="weui_btn weui_btn_mini weui_btn_warn delete_button" onclick="delete_button(&quot;1345&quot;)">删除</span></div>';
            html +='</div>';
            html +='</a>';
