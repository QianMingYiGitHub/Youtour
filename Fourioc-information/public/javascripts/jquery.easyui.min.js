...
p_t._outerHeight(opts.tabHeight-2);
...
$.fn.tabs.defaults={width:"auto",height:"auto",headerWidth:150,tabWidth:"auto",tabHeight:39,selected:0,showHeader:true,plain:false,fit:false,border:true,justified:false,narrow:false,pill:false,tools:null,toolPosition:"right",tabPosition:"top",scrollIncrement:100,scrollDuration:400,onLoad:function(_399){
...
return opts.min+(opts.max-opts.min)*(pos/size);
    ...
    $(".tabs").css('height','35px');
    $(".tabs-header").css('width','100%');
    $(".tabs-inner").css('height','35px');
    $(".panel-body-noborder").eq(1).css('height','800px');
})(jQuery);
